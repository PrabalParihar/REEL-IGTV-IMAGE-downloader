...
<br/><br/>
      ...
      <div class="row tm-albums-container grid">
        ...
        <div class="col-sm-6 col-12 col-md-6 col-lg-3 col-xl-3 tm-album-col">
          <figure class="effect-sadie">
            <img src="img/3-img.jpg" alt="Image" class="img-fluid">
            <figcaption>
              <h2></h2>
              <p>And in her smile I see something more beautiful than the stars..</p>
            </figcaption>
          </figure>
        </div>
        <div class="col-sm-6 col-12 col-md-6 col-lg-3 col-xl-3 tm-album-col">
          <figure class="effect-sadie">
            <img src="img/4img.jpg" alt="Image" class="img-fluid">
            <figcaption>
              <h2></h2>
              <p> It is our window to the entire world, a window within the grasp of our palms, and the touch of our fingertips.
        ...
        <div class="col-sm-6 col-12 col-md-6 col-lg-3 col-xl-3 tm-album-col">
          <figure class="effect-sadie">
            <img src="img/6img.jpg" alt="Image" class="img-fluid">
            <figcaption>
              <h2></h2>
              <p>Social media is for the far sighted..</p>
            </figcaption>
          </figure>
        </div>
        <div class="col-sm-6 col-12 col-md-6 col-lg-3 col-xl-3 tm-album-col">
          <figure class="effect-sadie">
            <img src="img/7img.jpg" alt="Image" class="img-fluid">
            <figcaption>
              <h2></h2>
              <p>No matter how plain a woman may be, if truth and honesty are written across her face, she will be beautiful.</p>
            </figcaption>
          </figure>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <h2 class="tm-tag-line-title">Reel Hot Videos is your powerful energy.</h2>
          </div>
        </div>
      </div>
